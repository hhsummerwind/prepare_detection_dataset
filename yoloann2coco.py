...
if __name__ == '__main__':
    ...
    saved_coco_path = "/data/datasets/tianji/hat/安全帽数据/coco/"
    # 整合csv格式标注文件
    ...
    # 把训练集转化为COCO的json格式
    l2c_train = YoloAnn2CoCo(image_dir=image_dir,total_annos=total_csv_annotations)
    ...
    # 把验证集转化为COCO的json格式
    l2c_val = YoloAnn2CoCo(image_dir=image_dir,total_annos=total_csv_annotations)
